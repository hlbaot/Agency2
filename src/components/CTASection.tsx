      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[40px] px-5 py-12 text-center sm:px-8 sm:py-14">
          ...
          <div className="relative z-10">
            ...
            <h2 className="mx-auto mb-6 max-w-3xl text-3xl font-black leading-[1.08] text-[#08152f] sm:text-4xl lg:text-5xl">
              {title}
            </h2>
            <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-[#6b7280] sm:text-xl sm:leading-[1.5]">
              {description}
            </p>
            <div className="mb-10 flex flex-wrap justify-center gap-4">
              {primaryButton.isExternal ? (
                <a
                  ...
                  className="inline-flex min-w-[220px] items-center justify-center gap-3 rounded-2xl bg-[#d4ae68] px-8 py-4 text-lg font-bold text-[#08152f] shadow-[0_12px_28px_rgba(212,174,104,0.22)] transition-all hover:cursor-pointer hover:-translate-y-0.5 hover:bg-[#c79f53]"
                >
                  {primaryButton.text}
